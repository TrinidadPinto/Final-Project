...
class Room(db.Model):
    ...
    host: Mapped["User"] = relationship(
        "User", back_populates="rooms", foreign_keys=[host_id])
    bookings: Mapped[list["Booking"]] = relationship(
        "Booking", back_populates="room")
    ...
    def serialize(self):
        return {
            ...
            "bookings": [
                {"check_in": b.check_in.isoformat(), "check_out": b.check_out.isoformat()} for b in self.bookings
            ]
        }
